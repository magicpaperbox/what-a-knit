...
class ProjectRepository:
    def _row_to_domain(self, project_row: ProjectRow, gauge_row: ProjectGaugeRow | None) -> Project:
        if gauge_row:
            gauge = Gauge(
    ...
    def get_all(self) -> list[Project]:
        ...
        for project_row in project_rows:
            ...
            projects.append(self._row_to_domain(project_row, gauge_row))
        return projects
    ...
    def get_by_id(self, project_id: ProjectId) -> Optional[Project]:
        ...
        return self._row_to_domain(project_row, gauge_row)
